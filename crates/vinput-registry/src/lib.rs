...
pub use schema::{
    AdapterEntry, AssetEntry, AssetPlanSummary, ChecksumPolicy, InstallPlan, InstallPlanSummary,
    ModelEntry, PlannedAsset, PlannedInstallAsset, RegistryEntryKind, RegistryIndex,
