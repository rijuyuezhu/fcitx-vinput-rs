...
fn config_validate_fails_for_duplicate_llm_adapter_ids() {
    let path = write_temp_config(
        r#"
        {
          ...
          "llm": {
            "adapters": [
              {"id":"adapter","command":"vinput-adapter"},
              {"id":"adapter","command":"vinput-adapter"}
            ]
          },
          "scenes": {
...
fn config_validate_fails_for_empty_llm_adapter_id() {
    let path = write_temp_config(
        r#"
        {
          ...
          "llm": {
            "adapters": [{"id":"   ","command":"vinput-adapter"}]
          },
          "scenes": {
            "active_scene": "raw",
            "definitions": [{"id":"raw","label":"Raw","candidate_count":0}]
...
fn config_validate_fails_for_empty_llm_adapter_env_key() {
    let path = write_temp_config(
        r#"
        {
          ...
          "llm": {
            "adapters": [{"id":"adapter","command":"vinput-adapter","env":{"":"bad"}}]
          },
          "scenes": {
            "active_scene": "raw",
            "definitions": [{"id":"raw","label":"Raw","candidate_count":0}]
...
fn config_validate_fails_for_empty_llm_adapter_working_dir() {
    let path = write_temp_config(
        r#"
        {
          ...
          "llm": {
            "adapters": [{"id":"adapter","command":"vinput-adapter","working_dir":"   "}]
          },
          "scenes": {
            "active_scene": "raw",
            "definitions": [{"id":"raw","label":"Raw","candidate_count":0}]
