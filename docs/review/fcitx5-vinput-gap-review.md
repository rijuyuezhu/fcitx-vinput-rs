...
5. Command ASR long-lived streaming lifecycle plus broader stderr/timeout/cancellation parity; batch raw PCM, one-shot `.streaming` JSON-line runners, duplicate-partial suppression, streaming capabilities, and D-Bus stop-time partial fixtures already exist.
